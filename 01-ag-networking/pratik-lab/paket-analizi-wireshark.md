...
- **Savunma tarafı:** Aynı beceri, forensics ([../../11-soc-mavi-takim/dijital-forensics.md](../../11-soc-mavi-takim/dijital-forensics.md)) ve olay analizinde bir saldırının ağ ayak izini (C2 bağlantısı, veri sızması, tarama) okumak için kullanılır. Network forensics, pcap okumaktır. Burada elle yaptığın paket okuma işini **ölçekli ve otomatik** yapan katman, ağ tabanlı tespit sistemleridir (NIDS/NIPS — Snort/Suricata/Zeek): aynı desen/anomali arama, tek pakette değil tüm ağ trafiğinde → [../../11-soc-mavi-takim/siem-edr-soar.md](../../11-soc-mavi-takim/siem-edr-soar.md) (§3.5).
