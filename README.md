...
![Diagrams](https://img.shields.io/badge/mermaid%20diyagram-129%2B-orange)
...
- [x] [10 · Pentest Metodolojisi](10-pentest-metodolojisi/metodoloji-ve-rules-of-engagement.md) — RoE, Nmap, zafiyet tarama, online/offline parola saldırıları, sömürü/privesc, Metasploit
- [x] [11 · SOC / Mavi Takım](11-soc-mavi-takim/siem-edr-soar.md) — SIEM/EDR/SOAR, log analizi, **dijital forensics, malware analizi, olay müdahalesi (IR)**
...
| [10-pentest-metodolojisi](10-pentest-metodolojisi/) | Bir sızma testinin yasal çerçevesinden keşif, zafiyet tarama, sömürü ve raporlamaya tüm yaşam döngüsü. |
| [11-soc-mavi-takim](11-soc-mavi-takim/) | Savunmanın operasyonel yüzü: tespit (SIEM/EDR/SOAR, log analizi) + olay sonrası (dijital forensics, malware analizi, olay müdahalesi). |
...
├── 00-baslangic/ → 15-projeler/  ← 16 modül, ~68 içerik dosyası
```
