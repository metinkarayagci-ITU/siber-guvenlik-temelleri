...
- [x] [10 · Pentest Metodolojisi](10-pentest-metodolojisi/metodoloji-ve-rules-of-engagement.md) — RoE, **OSINT keşif**, Nmap, zafiyet tarama, parola saldırıları, sömürü, **privilege escalation (derin)**, **Active Directory saldırıları**, pivoting, Metasploit
...
| [10-pentest-metodolojisi](10-pentest-metodolojisi/) | Bir sızma testinin tüm yaşam döngüsü: RoE, keşif, zafiyet tarama, sömürü, privilege escalation, Active Directory saldırıları, pivoting, raporlama. |
